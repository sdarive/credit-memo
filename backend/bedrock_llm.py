...
"""
        ...
        prompt = f"""You are an experienced credit analyst at Midwest Regional Bank preparing a credit memo for loan underwriting.
...
TEMPLATE STRUCTURE:
Start your memo with this exact header (use ASCII art borders):
...
Prepared by: Ernie - AI Credit Assistant
Generated by: AWS Bedrock & LandingAI Technology

═══════════════════════════════════════════════════════════════════════

Then generate a comprehensive credit memo following this bank-approved template, adhering to the "5 Cs of Credit" framework (Character, Capacity, Capital, Collateral, Conditions):
